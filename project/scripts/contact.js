...
function populateTimestamp() {
  ...
  timestampInput.value = new Date().toLocaleString(); // Captures the current date and time
};
...
document.querySelector('#results').innerHTML = `
    <p>Thank you, ${firstName} ${lastName}, for planning your visit!</p>
...
document.querySelector('#results').innerHTML = `
<p>Thank you ${myInfo.get('fname')} ${(myInfo.get('lname'))}, for planning your visit!</p>
<p>We have your information as: </p>
